          ...
          <div className="flex flex-col gap-8">
            <header className="flex flex-col gap-4">
              ...
              <p className="max-w-2xl text-pretty text-lg leading-8 text-[#402516]/85 sm:text-xl">
                <span className="block">DRESZI is a personal style intelligence system.</span>
                <span className="block">A guide that brings clarity, intention, and calm to the daily ritual of getting dressed.</span>
              </p>
            </header>
            ...
            <p className="text-sm text-[#402516]/70">
              Prefer email?{" "}
              <a className="font-medium text-[#402516] hover:underline" href="mailto:hello@dresz.io">
                hello@dresz.io
              </a>
            </p>
        ...
        <section id="manifesto" className="mt-10 rounded-2xl border border-[#402516]/10 bg-white/30 p-8 sm:p-12">
          <div className="max-w-3xl">
            ...
            <div className="mt-6 space-y-5 text-base leading-8 text-[#402516]/90 sm:text-lg">
              <p>
                <span className="block">It is not a stylist.</span>
                <span className="block">Not a store.</span>
                <span className="block">Not a trend machine.</span>
              </p>
              <p>
                <span className="block">It is a companion that understands the person deeply enough to help them dress with ease and purpose.</span>
                <span className="block">A clarity engine disguised as a wardrobe assistant.</span>
                <span className="block">A philosophy translated into software.</span>
              </p>
              <p>
              ...
              <p className="text-sm text-[#402516]/75">
                Contact:{" "}
                <a className="font-medium text-[#402516] hover:underline" href="mailto:hello@dresz.io">
                  hello@dresz.io
                </a>
